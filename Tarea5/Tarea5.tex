...
\begin{solution} 
    ...
    Con la envolvente calculada, podemos regresar a distribución Gamma, sin logaritmos, al igual que a la envolvente, donde vemos que dicha envolvente es una mezcla de exponenciales. 
    \begin{figure}[H] 
        \centering 
